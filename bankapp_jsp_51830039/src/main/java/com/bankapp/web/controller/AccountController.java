...
public class AccountController {
	...
	@Autowired
	private TransactionLogService transactionLogRepository;
	/*
	...
	public ModelAndView allAccounts(ModelAndView mv) {
		...
		mv.addObject("accounts", accService.getAllAccounts());
		return mv;
	...
	return "redirect:all_accounts";
		...
		@RequestMapping(value="all_transaction",method=RequestMethod.GET)
		public ModelAndView allTransaction(ModelAndView mv){
			mv.setViewName("all_transaction");
			mv.addObject("transaccount", transactionLogRepository.getAllTransaction());
			return mv;
