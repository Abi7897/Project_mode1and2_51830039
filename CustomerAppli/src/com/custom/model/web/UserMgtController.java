...
import com.custom.model.persistance.UserNotFoundException;
import com.custom.model.service.UserService;
...
private UserService userService;
	...
	public void init(){
		...
		userService.addUser(new User("kavi","kavi@g.com","kavi123","emp",true));
		userService.addUser(new User("pavi","pavi@g.com","pavi123","admin",true));
		userService.addUser(new User("varan","varan@g.com","varan123","mgr",true));
	}
